		        ...
		        <div className="relative pt-[56.25%]">
		        	...
		        	<div className="absolute bottom-10 flex w-full items-center justify-between px-10">
		        		<div className="flex space-x-2">
							<button className="flex items-center gap-x-2 rounded bg-white text-sm font-small px-8 text-xl font-bold text-black transition hover:bg-[#e6e6e6]">
							...
							<button className="modalButton text-sm font-small">
